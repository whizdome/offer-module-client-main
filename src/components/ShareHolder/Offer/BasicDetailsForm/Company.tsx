...
import { BasicDetailsCompanyFormSchema } from "@/validations/offer.validations";
...
const BasicDetailsCompanyForm: FC<Props> = ({
	notification,
	handleProceed,
}) => {
	...
	const formik = useFormik({
		...
		validationSchema: BasicDetailsCompanyFormSchema,
					...
					basicDetailCommand: [
						{
							...
							companyRegisteredAddress: values.companyRegisteredAddress,
	...
	return (
		<div className="sm:w-[486px] w-full px-4 space-y-4  ">
			<form className=" bg-white border border-ap-grey-100 shadow-xl ">
				<div className="px-6 py-4">
					...
					<div className="flex flex-col gap-4 mb-4">
						...
						<TextInput
							...
							label="Company Registration Number (RC)"
				...
				<div className="border-t border-[#EDEEF1] py-5 flex  ">
					<AppButton
						type="submit"
						value={"Submit"}
						className="ml-auto"
...
export default BasicDetailsCompanyForm;
