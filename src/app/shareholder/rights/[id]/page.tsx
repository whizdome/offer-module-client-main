...
const ShareholderOfferDetails = () => {
	...
	const offerDetails = Object.fromEntries(
		searchParams.entries()
	) as unknown as IEquityOfferingResponse;
	...
	return (
		<div className="min-h-screen layout-background mx-auto">
			<div className="max-w-screen-xl xl:px-0 sm:px-20 mx-9 px-4">
				<AppButton
					value="Back"
					icon={<FaArrowLeft />}
				...
				<div className="flex items-center gap-4">
					...
					<p className="text-ap-grey-950 font-semibold text-lg md:text-2xl">
						{offerDetails.symbol} {offerDetails.type}
					</p>
				</div>
				<div
...
export default ShareholderOfferDetails;
